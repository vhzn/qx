...
================Loon==============
[Script]
cron "30,31 20-23 3-8 2 *" script-path=https://raw.githubusercontent.com/i-chenzhe/qx/main/jd_half_red_rain.js, tag=超级直播间红包雨
===============Surge=================
超级直播间红包雨 = type=cron,cronexp="30,31 20-23 3-8 2 *",wake-system=1,timeout=200,script-path=https://raw.githubusercontent.com/i-chenzhe/qx/main/jd_half_red_rain.js
============小火箭=========
超级直播间红包雨 = type=cron,script-path=https://raw.githubusercontent.com/i-chenzhe/qx/main/jd_half_red_rain.js, cronexpr="30,31 20-23 3-8 2 *", timeout=200, enable=true
 */
const $ = new Env('半点红包雨');
...
function getRedRainId() {
    let opt = {
        ...
        body: `adid=&area=&body=%7B%22liveId%22%3A%223445605%22%7D&build=167538&client=apple&clientVersion=9.3.8&d_brand=apple&d_model=iPhone10%2C3&eid=eidI3b0581236ds3Wm%2BpvIJQQbCvU6sxxq%2BBoVpvqzMVRPoBl589FdBGvSOpyjOoXslyKEN6vwzGuwV2fN42sBkqrujWwPXYVBW6Er33gHfBsUH7hLc3&isBackground=N&joycious=15&lang=zh_CN&networkType=wifi&networklibtype=JDNetworkBaseAF&openudid=b9b73293715e562295c0f0aac9d15035ea9b4889&osVersion=14.3&partner=apple&rfs=0000&scope=01&screen=1125*2436&sign=589b414c358c1ea8d33622a7f2997d4e&st=1612276916428&sv=100&uts=&uuid=&wifiBssid=`
    }
